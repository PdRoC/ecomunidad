    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .page-wrapper { width: 100%; padding: 2rem 2rem 4rem; }
        ...
        .user-info strong { color: #3a2c14; font-weight: 700; }
      ...
      <div className="page-wrapper">
        <header className="page-header">
          <div className="header-info">
            ...
            <p className="sub">Grupos de celebración · Última generación</p>
            <span className="comunidad-tag">{nombreComunidad}</span>
          </div>
